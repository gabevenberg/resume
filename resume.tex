...
\section*{Gabriel Venberg}
    ...
    \textsc{Address:} & Rheingaustraße 23a 65201 Wiesbaden, DE &
...
\begin{description}
    ...
    \item[Frameworks: ] Yocto linux, Zephyr, Embassy, Nixpkgs, Pytest
    \item[Protocols: ] MQTT, REST, Embedded comms (SPI, I2C, UART, etc)
    \item[Tools:] Git, \LaTeX{}, Vim, Jenkins, KiCad
    \item[Linux Administration:] NGINX, Caddy, Docker, NixOS, Proxmox, SystemD, PostgreSQL
\end{description}
...
\section*{Work Experience}
    ...
    {May 2026--Current}
    {
        Working as a software engineering consultant, I helped clients by:
        \begin{itemize}
            \item Improved range of clients radio communication system by 5 times.
            \item Analyzed code, architecture, and process quality for clients,
                giving concrete recommendations and action items for improvement.
        \end{itemize}
    }
    ...
    {
        \begin{itemize}
            \item Developed Linux distributions for an embedded system with Yocto Linux.
            \item Implemented package management and remote updates for Yocto Linux system.
            \item Implemented smart switching between Wifi and LTE in Linux system.
            \item Developed a Zephyr RTOS based wearable IOT device for tracking of patient conditions.
            ...
            \item Collaborated with backend software team for backwards compatible data format changes
        ...
        {January 2023--May 2023}
        {
            \begin{itemize}
                \item Implemented a Rust-based log parser for the Kata Containers project,
                    ...
                    Writing the tool in Rust allowed it to be integrated with the projects existing CLI tools.
...
\section*{Other Experience}
    \experience
        ...
        {2025--present}
        {
            Author of \href{https://github.com/gabevenberg/crabroll}{Crabroll}, a open source stepper motor window blind controller for Home Assistant, built in Rust and running on an ESP32c3.
        }
